...
contract GenesisNFT is ERC721, Ownable{
    ...
    uint256[3] public mintTime = [1681965000, 1681966200, 1681967400];
    ...
    function mint() public payable {
        ...
        if(round == 1) {
            ...
            require(ownerToGenesis[msg.sender] < whiteListLevel[msg.sender], "Limit NFT for your level!");
        }
        else if (round == 2){
            require(whiteListLevel[msg.sender]>0, "You'r not in whitelist");
            require(waitList[msg.sender], "You'r not in waitlist");
            require(ownerToGenesis[msg.sender] < 1, "You only mint 1 NFT");
        } else {
            require(ownerToGenesis[msg.sender] < 1, "You only mint 1 NFT");
        }
    ...
    // Populate WhiteList
    function setWaitList(address[] memory addresses) external onlyOwner {
